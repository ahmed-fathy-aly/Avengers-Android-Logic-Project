...
/**
 * The circuit which contains the flipflops, internals, inputs,
...
public class Circuit
{
	 ...
	 *            the Circuit object
	 */
	public void createCicuit(TextInputReaderAndroid reader)
	{
		// Create the inputs
		...
		// MainActivity.storeMessage("J 1" + flipflops.get(1).getNextState());
	...
	private void createJK(String in1, String in2, String out)
	{
		...
		// Check if the in wire is just a wire already known to the circuit
			...
			MainActivity.storeMessage("Error, the wire " + in1
		...
		// Check if the in wire is just a wire already known to the circuit
			...
			MainActivity.storeMessage("Error, the wire " + in2
					+ " isn't in the circuit");
		...
		// Check if the in wire is just a wire already known to the circuit
			...
			MainActivity.storeMessage("Error, the wire " + out
					+ " isn't in the circuit");
	...
	private void createInverter(String in, String out)
	{
		...
		// Check if the in wire is just a wire already known to the circuit
			...
			MainActivity.storeMessage("Error, the wire " + in
					+ " isn't in the circuit");
